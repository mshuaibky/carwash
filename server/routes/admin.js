...
router.get('/dwnloadAdminNewList/:data?',dwnldAdminList)
router.get('/deleteNewList',newListDelete)
router.post('/getrenewedListEmployee',getEmployeerenewedList)
router.post('/newListSearchData',newListSearch)
